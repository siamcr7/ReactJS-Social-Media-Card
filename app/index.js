var person = {
    ...
    updates: [
        ...
        {
            platform: 'facebook',
            status: 'If you\’re working on something that you think is going to get accomplis hed in this lifetime then you’re not thinking big enough'
        }
    ]
}
...
class Photo extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="photo">
                <img src={this.props.imgLoc} alt="Photo"/>
            </div>
        )
            ...
            <div className="bio">
                ...
                <div className="occupation">
                    <p>
                        ...
                        {' at '} {this.props.occupation.employer}
                    </p>
                </div>
            </div>
        )
